...
const services = [
  ...
  {
    title: "Rentals",
    desc: `Simple solution to get you back on the road! All we need is proof of address.
​`,
    image: "/gray.avif",
  ...
  {
    title: "Car Sale",
    desc: `All our vehicles will be sold with at least 6 months MOT and 3 Months national warranty`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[68%] mx-auto mt-20 h-15 object-cover"
                    onError={(e) => {
